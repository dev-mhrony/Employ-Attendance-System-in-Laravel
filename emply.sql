...
CREATE TABLE `admin_mail_campaign_detail` (
  `id` int NOT NULL,
  `admin_template_id` int DEFAULT NULL,
  `admin_mail_config_id` int DEFAULT NULL,
  `user_id` int NOT NULL,
  `user_email` varchar(255) DEFAULT NULL,
  `receipt_status` tinyint(1) DEFAULT '0',
  `receipt_time` int DEFAULT NULL,
...
(1, 'admin', '01608445456', '66607ecca78f8d851be7d8cd8779168f', 1, 1, 'FauAYEWKEbalwBsIXbhM1l0s0MjRJOVvxvuWqnI3uS5Mdv0JKBDRx4SUjthh', NULL, 2147483647, 2147483647, 0),
...
(1, 1, NULL, NULL, 'admin@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
